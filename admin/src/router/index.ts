...
const routes: RouteRecordRaw[] = [
  { path: "/login", name: "login", meta: { title: "Đăng nhập" }, component: () => import("@/features/auth/LoginPage.vue") },
  {
    ...
    children: [
      ...
      { path: "ipn", name: "ipn", meta: { title: "IPN Logs" }, component: () => import("@/features/premium/IpnLogsPage.vue") },
      ...
      { path: "audit", name: "audit", meta: { title: "Audit Log" }, component: () => import("@/features/audit/AuditPage.vue") },
      { path: "system", name: "system", meta: { title: "System" }, component: () => import("@/features/system/SystemPage.vue") },
