...
export function BriefingCard({ data }: { data: BriefingCardType }) {
  ...
  return (
    <article className="briefing">
      ...
      <div className="briefing-trend-row" data-tour-id="tour-phantich-trend">
        <div className="field">
      ...
      {/* Khối 2 — Narrative */}
      <p className="narrative serif" data-tour-id="tour-phantich-narrative">
        <NarrativeText fragments={data.narrative} />
      </p>

      {/* Khối 3 — Diff block */}
      <div className="diff-block" data-tour-id="tour-phantich-diff">
        <span
      ...
      {/* Khối 4 — Observations */}
      <div className="observations" data-tour-id="tour-phantich-observations">
      ...
      {/* Khối 5 — Watch levels */}
      <div className="watch-levels" data-tour-id="tour-phantich-levels">
      ...
      {/* Khối 6 — Verdict */}
      <div className="verdict" data-tour-id="tour-phantich-verdict">
