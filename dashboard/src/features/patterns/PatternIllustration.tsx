 ...
 *
 * Ported from dashboard-bak. Renders candlestick + classical chart patterns as
 * self-scaling SVGs that follow the app price palette (emerald = up, red =
 * down, amber = doji/neutral). Grid + axis text use Arco CSS vars so the
 * visuals adapt to light/dark automatically.
 *
 ...
 * 15 classical chart patterns (Ascending Triangle, Head & Shoulders, …) with
 * reference lines for the neckline / support / resistance.
 */
