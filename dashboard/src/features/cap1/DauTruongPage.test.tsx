...
function fakeCap7Progress(overrides: Record<string, unknown> = {}) {
  return {
    ...
    so_ma_dang_giu: 0,
    so_nganh_dang_giu: 0,
    ma_ty_trong_cao_nhat: null,
    ty_trong_ma_cao_nhat_pct: null,
    nganh_ty_trong_cao_nhat: null,
    ty_trong_nganh_cao_nhat_pct: null,
    ma_chua_co_gia: [],
    ma_chua_ro_nganh: [],
    du_lieu_day_du: false,
    nguong_ty_trong_ma_pct: 30,
    nguong_ty_trong_nganh_pct: 40,
    toi_thieu_ma: 4,
    toi_thieu_nganh: 3,
    graduated_at: null,
    time_to_graduate_hours: null,
