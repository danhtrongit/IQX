...
export function SessionTabs({
  ...
  return (
    <div
      ...
      className="mb-6 flex gap-1 overflow-x-auto border-b border-[var(--color-border-2)]"
    >
      {TABS.map((t) => {
        ...
        return (
          <button
            ...
            className={cn(
              "-mb-px flex shrink-0 items-center gap-2 border-b-2 px-4 py-3 text-[13px] font-medium transition-colors",
              isActive
          ...
          >
            ...
            {t.label}
            <span className="hidden sm:inline font-mono text-[11px] text-[var(--color-text-3)]">{t.time}</span>
            {newPeriod === t.id ? (
