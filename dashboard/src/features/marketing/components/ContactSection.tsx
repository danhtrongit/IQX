import { IconEmail, IconMessage, IconLocation, IconPhone } from "@arco-design/web-react/icon"
...
export default function ContactSection() {
  const items: {
    ...
    {
      icon: <IconEmail style={{ fontSize: 20 }} />,
      label: "Email",
      value: "support@iqx.vn",
      href: "mailto:support@iqx.vn",
    },
    {
      icon: <IconPhone style={{ fontSize: 20 }} />,
      label: "Hotline",
      value: "0901 234 567",
      href: "tel:0901234567",
    },
    ...
    {
      icon: <IconLocation style={{ fontSize: 20 }} />,
      label: "Địa chỉ",
