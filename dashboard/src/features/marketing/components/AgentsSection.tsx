...
import { IconBranch, IconScan } from "@arco-design/web-react/icon"
import { IconBars, IconTrendLineChart, IconBot } from "@/shared/icons"

const agents: { icon: ReactNode; title: string; desc: string; color: string }[] = [
  {
    icon: <IconScan style={{ fontSize: 24 }} />,
...
export default function AgentsSection() {
  return (
    <section id="agents" style={{ position: "relative", padding: "120px 40px", background: "#000" }}>
