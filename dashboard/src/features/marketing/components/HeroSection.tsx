...
import { IconArrowRise, IconSwap, IconUserGroup, IconThunderbolt } from "@arco-design/web-react/icon"
import { IconDroplet, IconNewspaper } from "@/shared/icons"

/** Render any Arco/custom icon at a pixel size + color (they don't take size/color props). */
function Glyph({
  icon: Icon,
  size,
  color,
...
> = {
  trend: {
    ...
    icon: IconArrowRise,
    color: "#3b82f6",
    summary: "Tăng — MA20 đi lên, giá trên hỗ trợ",
  },
  liquidity: {
    label: "Thanh khoản",
    short: "L2",
    icon: IconDroplet,
    color: "#06b6d4",
    summary: "Cải thiện, volume vượt TB30",
  },
  moneyFlow: {
    label: "Dòng tiền lớn",
    short: "L3",
    icon: IconSwap,
    color: "#10b981",
    summary: "Khối ngoại mua ròng 3 phiên",
  },
  insider: {
    label: "Sự kiện",
    short: "L4",
  ...
  news: {
    ...
    icon: IconNewspaper,
    color: "#ec4899",
    summary: "Doanh thu kỷ lục quý 4",
  },
}
    ...
    <>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 6 }}>
          <Glyph icon={cfg.icon} size={16} color={cfg.color} />
        ...
        <p style={{ fontSize: 11, color: "rgba(255,255,255,0.65)", lineHeight: 1.4, margin: 0 }}>
          {cfg.summary}
        </p>
      </div>
    </>
...
function DemoCenterNode(_: NodeProps) {
  return (
    <>
      <Handle
        type="target"
      ...
      >
        ...
        >
          <Glyph icon={IconThunderbolt} size={18} color="#00A8E8" />
        ...
        >
          <p style={{ fontSize: 11, color: "rgba(255,255,255,0.8)", lineHeight: 1.5, margin: 0 }}>
            ⚡ Giữ vị thế — Cấu trúc giá tăng vững chắc, thanh khoản tốt. Được dòng tiền thông minh hỗ
            trợ mạnh mẽ.
          </p>
        </div>
      </div>
...
export default function HeroSection() {
  ...
  const chips: { label: string; icon: ComponentType<{ style?: CSSProperties }>; color: string }[] = [
    { label: "Xu hướng", icon: IconArrowRise, color: "#3b82f6" },
    { label: "Thanh khoản", icon: IconDroplet, color: "#06b6d4" },
    { label: "Dòng tiền lớn", icon: IconSwap, color: "#10b981" },
    { label: "Sự kiện", icon: IconUserGroup, color: "#f59e0b" },
    { label: "Tin tức", icon: IconNewspaper, color: "#ec4899" },
    { label: "Hành động & Kịch bản", icon: IconThunderbolt, color: "#00A8E8" },
  ]
    ...
    >
      ...
      >
        ...
        <div>
          ...
          >
            Dữ liệu đa nguồn bảo chứng độ tin cậy – AI dựa trên dữ liệu để phân tích đa chiều và gợi ý
            hành động.
          </p>
          ...
          >
            <button
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = "0 8px 28px rgba(0,168,232,0.35)"
              }}
              onMouseLeave={(e) => {
        ...
        <div
          className="animate-fade-in-up animation-delay-400"
          style={{ height: "100%", maxHeight: "80vh", display: "flex", flexDirection: "column" }}
        >
          <div
            style={{
              flex: 1,
          ...
          <div style={{ padding: "24px 0 0", textAlign: "center" }}>
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: 10, flexWrap: "wrap" }}>
              {chips.map((l) => (
                ...
                >
                  <Glyph icon={l.icon} size={12} color={l.color} />
                  {l.label}
                </span>
              ))}
            </div>
