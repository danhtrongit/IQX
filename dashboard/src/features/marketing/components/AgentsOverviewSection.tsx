...
import { IconArrowRise, IconSwap } from "@arco-design/web-react/icon"
import { IconCandlestick, IconBars, IconZap, IconTarget } from "@/shared/icons"

type Glyph = ComponentType<{ style?: CSSProperties }>

const agents: { icon: Glyph; title: string; desc: string }[] = [
  {
...
export default function AgentsOverviewSection() {
  return (
    <section
      id="agents-overview"
      style={{ padding: "80px 20px", background: "#000", position: "relative" }}
    >
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "48px" }}>
          ...
          >
            Hệ thống các AI chuyên biệt xử lý từng khía cạnh của thị trường để mang lại góc nhìn sâu
            sắc nhất.
          </p>
        </div>
        <div
