...
import { IconBars, IconActivity } from "@/shared/icons"
...
const signals: {
...
}[] = [
  {
    ...
    status: "Tín hiệu mua",
    statusColor: "#22c55e",
    icon: <IconArrowRise style={{ fontSize: 18 }} />,
    price: "23,300",
  },
  {
    symbol: "VIC",
    ...
    statusColor: "#f59e0b",
    icon: <IconActivity style={{ fontSize: 18 }} />,
    price: "45,000",
  },
  {
    symbol: "FPT",
    ...
    statusColor: "#ef4444",
    icon: <IconBars style={{ fontSize: 18 }} />,
    price: "128,500",
  },
]
...
export default function InsightSection() {
  return (
    <section
      id="insight"
      style={{ position: "relative", padding: "60px 40px", background: "#000", overflow: "hidden" }}
    >
      <div
        style={{
          position: "absolute",
        ...
        >
          ...
          >
            ...
            >
              ...
              <div
                style={{
                  ...
                  borderRadius: "50%",
                  animation: "iqx-spin 1s linear infinite",
                }}
              />
            </div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "0", marginTop: "24px" }}>
              <div
                style={{ width: "10px", height: "10px", borderRadius: "50%", background: "#00A8E8" }}
              />
              <div
                style={{
                  flex: 1,
          ...
          <div>
            ...
            >
              AI liên tục cập nhật tín hiệu, ngưỡng quan trọng và kịch bản (tốt/xấu/đi ngang) để bạn
              ra quyết định có cơ sở và quản trị rủi ro tốt hơn.
            </p>
