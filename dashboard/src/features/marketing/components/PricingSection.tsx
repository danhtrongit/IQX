...
import { IconZap, IconCrown, IconRocket } from "@/shared/icons"
...
const plans: {
  ...
  {
    name: "Gói 1 Tháng",
    icon: <IconZap style={{ fontSize: 22 }} />,
  ...
  {
    name: "Gói 6 Tháng",
    icon: <IconCrown style={{ fontSize: 22 }} />,
    pricePerMonth: 90000,
    totalPrice: 540000,
    badge: "Tiết kiệm 10%",
  ...
  {
    name: "Gói 1 Năm",
    icon: <IconRocket style={{ fontSize: 22 }} />,
    pricePerMonth: 80000,
    totalPrice: 960000,
    badge: "Tiết kiệm 20%",
    ...
    <section id="pricing" style={{ position: "relative", padding: "60px 40px", background: "#000" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "40px" }}>
          ...
          >
            Sử dụng trọn bộ công cụ AI phân tích chuyên sâu mà không bị giới hạn tính năng ở bất kỳ gói
            nào. Tùy chọn thời hạn phù hợp với bạn.
          </p>
        </div>
          ...
          {plans.map((plan, i) => (
            <div
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = plan.popular
                  ? "0 16px 60px rgba(0, 168, 232, 0.15)"
            ...
            >
              ...
              <div style={{ marginBottom: "6px" }}>
                ...
                >
                  {fmtVndAmount(plan.pricePerMonth)}
                </span>
                <span
                  style={{
                    fontSize: "16px",
              ...
              >
                /tháng {plan.totalPrice && `· Thanh toán ${fmtVndAmount(plan.totalPrice)} VND`}
              </p>
                ...
                {features.map((f) => (
                  <div key={f} style={{ display: "flex", alignItems: "flex-start", gap: "10px" }}>
                    <IconCheck
                      style={{
                        fontSize: 16,
                        color: plan.popular ? "#00A8E8" : "rgba(255,255,255,0.2)",
                        flexShrink: 0,
                        marginTop: "2px",
                      }}
                    />
                    <span
                      style={{ fontSize: "14px", color: "rgba(255,255,255,0.7)", lineHeight: 1.4 }}
                    >
                      {f}
                    </span>
                  </div>
