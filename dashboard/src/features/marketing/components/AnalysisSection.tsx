...
import { IconBulb, IconGitCompare, IconShieldAlert } from "@/shared/icons"
...
const axes: Axis[] = [
  {
    icon: <IconBulb style={{ fontSize: 28 }} />,
  ...
  {
    icon: <IconGitCompare style={{ fontSize: 28 }} />,
  ...
  {
    icon: <IconShieldAlert style={{ fontSize: 28 }} />,
...
export default function AnalysisSection() {
  return (
    <section id="analysis" style={{ position: "relative", padding: "120px 40px", background: "#000" }}>
                ...
                <>
                  ...
                  >
                    ...
                    >
                      ...
                      <span
                        style={{ fontSize: "13px", color: "rgba(255,255,255,0.2)", fontWeight: 500 }}
                      >
                        Minh họa phân tích
                      </span>
                    </div>
