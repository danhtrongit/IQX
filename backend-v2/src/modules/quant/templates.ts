...
export const STRATEGY_TEMPLATES = [
  {
    ...
    config: {
      ...
      risk: risk({ stop_loss: 'atr', stop_atr_mult: 2, max_holding: 60 }),
    },
  },
  {
    key: 'volume_breakout',
    ...
    config: {
      ...
      sell: { logic: 'OR', factors: [{ id: 'breakdown_20d' }, { id: 'macd_bear_cross' }] },
      risk: risk({ stop_loss: 'atr', stop_atr_mult: 1.5, take_profit_pct: 0.15, max_holding: 40 }),
    },
  },
  {
    key: 'trend_follow',
    ...
    config: {
      ...
      sell: { logic: 'OR', factors: [{ id: 'close_below_ma50' }, { id: 'death_cross' }] },
      risk: risk({ stop_loss: 'atr', stop_atr_mult: 3, max_holding: 90 }),
    },
  },
  {
    key: 'mean_reversion',
    ...
    config: {
      buy: {
        logic: 'AND',
        factors: [
          { id: 'rsi_14_oversold', value: 28 },
          { id: 'dist_ma_20_buy', value: -0.05 },
        ],
      },
