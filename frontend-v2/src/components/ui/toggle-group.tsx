...
function ToggleGroup({
  ...
  return (
    <ToggleGroupPrimitive.Root
      ...
      className={cn(
        "group/toggle-group flex h-8 w-fit flex-row items-center gap-[--spacing(var(--gap))] overflow-hidden rounded-sm data-vertical:h-auto data-vertical:flex-col data-vertical:items-stretch",
        className
      )}
      {...props}
    >
