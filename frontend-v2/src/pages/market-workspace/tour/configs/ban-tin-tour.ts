...
/** 23 spotlight stops for the market brief (trước / giữa / cuối phiên). */
export const banTinTour: TourConfig = {
  name: "bantin",
  steps: [
    { targetId: "tour-bantin-pre-header", tang: "TRƯỚC PHIÊN", title: "Trước phiên · 07:15 — để CHUẨN BỊ", body: "Bản tin xuất bản 07:15 mỗi sáng. Trên đầu có **tiêu đề chính** tóm cả bài, và **Loại phiên** (An toàn · Tăng yếu · Đi ngang…) là chẩn đoán ngắn cho phiên hôm nay. Đọc 3 dòng này là đủ để quyết định có đọc chi tiết hay không." },
